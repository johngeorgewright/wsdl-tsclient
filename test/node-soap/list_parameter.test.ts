...
describe(target, () => {
    ...
    it(`${target} - check definitions`, async () => {
        ...
        expect(existsSync(`${outdir}/listparameter/definitions/AddTimesheetWithDefaultDistributionResponse.ts`)).toBe(true);
        ...
        expect(existsSync(`${outdir}/listparameter/definitions/GetTimesheetValuesWithRelatedColumnsResponse.ts`)).toBe(true);
